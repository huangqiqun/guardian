<jsp:directive.include file="default/ui/includes/top.jsp" />
	<div id="welcome">
			<h2>Guardian is Unavailable</h2>

			<p>
			  There was a fatal error initializing the Guardian application context.  This is almost always because of an error in the Spring bean configuration files.
			  Are the files valid XML?  Do the beans they refer to all exist?<br /><br />
			  Before placing Guardian in production, you should change this page to present a UI appropriate for the case where the Guardian
			  web application is fundamentally broken.  Perhaps "Sorry, Guardian is currently unavailable." with some links to your user support information.
			</p>
